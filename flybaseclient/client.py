...
import urllib2
import sys
from flybaseclient import settings, validators, errors, json_util
...
class FlybaseClient(object):
    ...
    then :class:`FlybaseClient` gets system proxy settings.
    ...
    def __init__(self, api_key, version=settings.VERSION_1, proxy_url=None):
        ...
        self.settings = settings.FlybaseSettings(version)
