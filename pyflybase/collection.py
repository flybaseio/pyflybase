...
from pyflybase import cursor, helpers


class Collection(object):
    """For instance this class, you needs an instance of
    :class:`pyflybase.database.Database` and the name of your collection.

    Example usage:

    .. code-block:: python

       >>> from pyflybase import MongoClient, database, collection
    ...
    .. code-block:: python
       ...
       >>> from pyflybase import MongoClient
       >>> con = MongoClient("DataMcFlyAPIKey")
       >>> db = con.database
       >>> db.collection
       Collection(Database(MongoClient('DataMcFlyAPIKey', 'v1'),
    ...
    @property
    def database(self):
        """An instance of :class:`pyflybase.database.Database` used for
        internal calls to DataMcFly REST API via :mod:`flybaseclient`.
        """
        return self.__database

    @property
    def full_name(self):
        """The full name of this :class:`pyflybase.collection.Collection`.
    ...
    def find(self, spec_or_id=None, fields={}, skip=0, limit=0, **kwargs):
        ...
        Returns an instance of :class:`pyflybase.cursor.Cursor` with the
        result set.
        ...
        .. code-block:: python
           ...
           <pyflybase.cursor.Cursor object at 0x1972490>
        ...
        if sort:
            if isinstance(sort, list):
                ...
                raise TypeError("sort must be a list of (key, direction) "
                                ...
                                "OrderedDict")
        out = self.database.iomand("findAndModify", self.name, **kwargs)
        if not out['ok']:
    ...
    def distinct(self, key):
        ...
        .. versionadded:: 1.2
        """
        return self.database.iomand({'distinct': self.name,
                                      'key': key})['values']
    ...
    def reindex(self):
        ...
        .. versionadded:: 1.2
        """
        result = self.database.iomand('reIndex', self.name)
